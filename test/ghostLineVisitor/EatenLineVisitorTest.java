...
class EatenLineVisitorTest {

    private EatenLineVisitor visitor;
    ...
    @BeforeEach
    void setUp() {
        visitor = new EatenLineVisitor();
    }

    @Test
    @DisplayName("Blinky에게 방문하면 'Nooo! I'll be back!' 대사를 설정한다")
    ...
    @Test
    @DisplayName("Pinky에게 방문하면 'So close!\\nI almost had him!' 대사를 설정한다")
    void testVisitPinky() {
        // given
    ...
    @Test
    @DisplayName("Inky에게 방문하면 'I knew this would happen...' 대사를 설정한다")
    void testVisitInky() {
        // given
    ...
    @Test
    @DisplayName("Clyde에게 방문하면 'Ouch! That hurt!' 대사를 설정한다")
    void testVisitClyde() {
        // given
    ...
    @Test
    @DisplayName("일반 Ghost에게 방문하면 'I've been eaten!' 대사를 설정한다")
    void testVisitGhost() {
        // given
    ...
    @Test
    @DisplayName("여러 유령들이 차례로 먹혔을 때 각각 다른 대사를 설정한다")
    void testMultipleGhostsEaten() {
        // given
        Blinky blinky = spy(new Blinky(100, 100, mockLevelConfig));
